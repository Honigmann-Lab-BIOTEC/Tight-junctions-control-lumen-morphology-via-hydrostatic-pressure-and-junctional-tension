...
import eu.kiaru.limeseg.commands.SkeletonSeg;
import ij.IJ;
import ij.ImagePlus;
...
def printoutmeasure (ResultsTable table, cell_id) {
	...
	// outputs a table that is later saved as excel file; xlsx or csv
    	...
    	table.addValue("Volume", my3Dobject.getVolume());
    	table.addValue("Surface", my3Dobject.getSurface());
...
String new_folder_name = "Cyst_test"
...
ij.command().run(SkeletonSeg.class,true,
            "d_0",4,//ADJUSTABLE 2.0 - 4.0
            "f_pressure",0,//ADJUSTABLE
            //"z_scale",2.53,
            "z_scale",10.15,
            "range_in_d0_units",4,//ADJUSTABLE, from ~ 0.5 to 20
            "show3D",true,
